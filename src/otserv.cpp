...
void mainLoader(int, char*[], ServiceManager* services)
{
	...
	//set RSA key
	const char* p("8718228122347309021022907733435222647887575378849969396158696838062745771782711655654894044129994569307854794295013733066166498352845412149142304646994643");
	const char* q("8245893160423771000143258966938137687146119795133836633469435324283101403983455505106973667287988054365184297132687561232716032352157006850805153646497217");
	g_RSA.setKey(p, q);
